...
DATA_DIR = "/content/emotion_data/dataset"  # hoặc path đúng từ cell trên
...
# ĐÓNG BĂNG toàn bộ features (không update gradient)
for param in model.features.parameters():
    param.requires_grad = False

#Thay classifier để phù hợp bài toán 6 classes
...
# Chỉ truyền params của classifier vào optimizer!
...
plt.suptitle("VGG16 - Feature Extraction (Transfer Learning)")
plt.tight_layout()
plt.show()
